...
<html lang="en">
    <head>
        ...
        <style>
           ...
           body {
                background-image: url(webroot/media/cat.jpg);
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="mynavbar">
                        <ul class="navbar-nav me-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="../202proyectoDWES/indexProyectoDWES.php"><i class="material-icons" style="font-size:48px;color:#FF5DA2">keyboard_backspace</i></a>
                            </li>
                        </ul>
                        <form class="d-flex">
