...
if ($entradaOK) {
    ...
    try {
        ...
        $sql2 = <<<OB
                UPDATE T01_Usuario 
                SET T01_NumConexiones=T01_NumConexiones+1 ,T01_FechaHoraUltimaConexion=$time
                WHERE T01_CodUsuario='$username'
                OB;
        ...
        $_SESSION['usuario202DWESAppLoginLogout'] = $username;
                ...
                <div class="d-flex mb-3">
                    ...
                    <div id="bg" class="p-2 flex-fill bg-dark">
                        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                            ...
                            <label><?php echo ($aErrores["username"] != null ? $aErrores['username'] : null); ?> </label>
                            <input type="password" name="password" value="<?php echo (isset($_REQUEST['password']) ? $_REQUEST['password'] : null); ?>"  placeholder="password">
                            <label><?php echo ($aErrores["password"] != null ? $aErrores["password"] : null); ?> </label>
